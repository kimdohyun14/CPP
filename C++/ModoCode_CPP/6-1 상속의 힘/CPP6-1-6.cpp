// 상속을 이용해서 사원 관리 프로그램에 적용하기

// C++은 다중 상속을 지원하므로 Java에서 사용하는 부모/자식 관계가 아닌
// 기반/파생 클래스로 쓴다.

// 상속을 이용하면 코드를 훨씬 간결하고 알아보기 쉽게 바꿀 수 있다.
// 이는 가독성 향샹과 유지보수가 좋아진다.
#include <iostream>
#include <string>
...
class Manager : public Employee {
	int year_of_service;  // 추가하려고 하는 부분문 추가적으로 선언
