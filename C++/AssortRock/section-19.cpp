...
int main()
{
	...
	메모리 영역중 힙영역에 공간이 할당된다. 힙의 특성상 메모리를 해제하기 전까지는 계속 남아있게 된다.
	...
	*/
	...
	// new 뒤에 들어오는 타입인 int인 크기만큼 공간을 할당한다.
	// 그 뒤에 할당한 공간의 메모리 주소를 pNumber에 넣어준다.
	// pNumber는 포인터 변수일 뿐이고, 힙 영역에 할당된 공간을 가리킨다.
	int* pNumber = new int;
	*pNumber = 100;
	...
	*/
	...
	// 메모리 공간에 400바이트만큼 공간을 할당하고 해당 메모리의 시작 주소를 반환한다.
