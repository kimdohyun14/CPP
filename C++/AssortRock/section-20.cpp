...
void InitList(PLIST pList)
{
	...
	// 초기화를 하지 않을 경우 쓰레기값이 들어가있는데 이 쓰레기값 조차 true이기 때문이다.
	pList->pBegin = NULL;
	pList->pEnd = NULL;
	pList->iSize = 0;
}
