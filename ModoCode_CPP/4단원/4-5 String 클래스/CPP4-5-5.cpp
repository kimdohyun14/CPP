// find 함수
// insert와 erase 이외에 매우 빈번하게 사용되는 함수이다.
// 문자열의 크기가 매우 크다면 find 연산은 엄청나게 오래 걸릴 수 있다.
#include <iostream>
#include <cstring>
...
int main() {
	...
	MyString str2("adbc");
	std::cout << "find index : " << str2.find(1, "db") << std::endl;
	std::cout << "find index : " << str2.find(2, "db") << std::endl;
	return 0;
}
